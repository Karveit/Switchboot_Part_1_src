...
#define JOYCON_OFF() PINOP(JOYCON_PIN, OUTCLR)
#define JOYCON_ON() PINOP(JOYCON_PIN, OUTSET)
#define JOYCON_TGL() PINOP(JOYCON_PIN, OUTTGL)

#define VOLUP_OFF() PINOP(VOLUP_PIN, OUTCLR)
#define VOLUP_ON() PINOP(VOLUP_PIN, OUTSET)
#define VOLUP_TGL() PINOP(VOLUP_PIN, OUTTGL)
